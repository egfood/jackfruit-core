...
SHIPPING_COST = 4
MODEL_FIELD_NAMES_FOR_CSV_EXPORT_PRODUCTS_IN_DELIVERY = {
    'id': 'id', 'name': 'название', 'price_by_weight': 'цена за вес', 'total_weight': 'общий вес',
    'total_price': 'итого', 'orders_count': 'заказов', 'supplier_id': 'поставщик'
}
