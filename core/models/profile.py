...
class UserProfile(FoodAbstract):
    ...
    tg_notify_dlvr_create = models.BooleanField(default=False, verbose_name="Создание новой доставки")
    tg_notify_dlvr_status = models.BooleanField(default=False, verbose_name="Изменение статуса доставки")
    tg_is_connected = models.BooleanField(default=False, verbose_name="Подключен пользователь Telegram")
    email_notify_dlvr_create = models.BooleanField(default=False, verbose_name="Создание новой доставки")
    email_notify_dlvr_status = models.BooleanField(default=False, verbose_name="Изменение статуса доставки")
    email_is_verified = models.BooleanField(default=False, verbose_name="Адрес email подтвержден")
